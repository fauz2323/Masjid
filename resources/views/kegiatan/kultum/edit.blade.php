...
@section('content')
    <div class="container bg-white p-5">
        <form action="{{ route('update-kultum',$data->id) }}" method="post">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1">Penceramah</label>
                <input type="text" class="form-control" name="ceramah" id="exampleInputEmail1" value="{{ $data->ceramah }}" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
