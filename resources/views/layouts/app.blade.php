            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('pengajian-index') }}">Pengajian</a>
                        <a class="collapse-item" href="{{ route('kultum-index') }}">Kultum</a>
                        <a class="collapse-item" href="{{ route('sholatJumat-index') }}">Sholat Jum'at</a>
                        <a class="collapse-item" href="">Ceramah Agama</a>
                        <a class="collapse-item" href="">Sholat Wajib</a>
                    </div>
                </div>
            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Siap utuk keluar?</h5>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="passwordnew" class="form-control" id="exampleInputPassword1" placeholder="Password">
                </div>
            </div>
            <div class="modal-footer">
